  ...
  return (
    <div className="rounded-2xl h-60 flex flex-col justify-between p-2 bg-white">
      <div className="relative">
        ...
        <span
          className="absolute top-3 left-3 bg-[#E0DACF] px-3 py-1 rounded-full text-sm"
      ...
      <div className="h-20 flex flex-col justify-end">
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            className="flex justify-center items-center gap-2.5 hover:bg-black hover:text-white px-3 py-1 border-2 text-sm rounded-full cursor-pointer"
            onClick={() =>
              dispatch(
