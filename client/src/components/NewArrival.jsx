...
export default function NewArrival() {
  ...
  return (
    <div className="my-10">
        <h3 className="text-3xl text-center underline underline-offset-5 mb-10 cursor-pointer" onClick={() => dispatch(getTagProductAsyncThunk({ tag: "new-arrival" }))}>New Arrival</h3>
      <Slider
        data={tagProducts}
        renderItem={(product) => (
